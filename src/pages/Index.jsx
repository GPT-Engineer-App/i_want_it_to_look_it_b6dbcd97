...
const Index = () => {
  return (
    <Container maxW="container.xl" p={4}>
      {/* Hero Section */}
      <Flex alignItems="center" justifyContent="center" direction="column" my={12} w="100%">
        ...
        <Box w={{ base: "80%", md: "50%" }} mt={{ base: 20, md: 10 }}>
          <Image src="https://images.unsplash.com/photo-1607746882042-944635dfe10e?ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxwc3ljaGVkZWxpYyUyMHBhdHRlcm58ZW58MHx8fHwxNzA0NDIyOTI2&ixlib=rb-4.0.3&q=80&w=1080" alt="Van Gogh Painting" borderRadius="lg" />
        </Box>
      </Flex>
      ...
      <Flex as="section" direction={{ base: "column", md: "row" }} justifyContent="space-between" alignItems="center" p={12} my={12} bg={useColorModeValue("gray.100", "gray.700")} borderRadius="lg">
...
const Episode = ({ title }) => (
  <Flex direction={{ base: "column", sm: "row" }} justifyContent="space-between" alignItems="center" p={4} bg={useColorModeValue("white", "gray.800")} borderRadius="lg" boxShadow="md">
    ...
    <Button mt={{ base: 4, sm: 0 }} leftIcon={<FaPlay />} colorScheme="purple">
      Play
    </Button>
  </Flex>
);
